...
class Tagx extends TagBase {
  ...
  static bool isValidTagIndex(int i) => TagBase.isValidTagIndex(i);

  /// Returns the [Tagx] corresponding to [index].
  static Tagx lookup(int index) => byIndex[index];

  /// Returns the [Tagx] corresponding to its [index].
  static Tagx fromIndex(int index) => byIndex[index];

  /// Returns the [Tagx] corresponding to the DICOM [code].
  static Tagx fromCode(int code) => byIndex[TagBase.tagCodeToIndex(code)];

  /// Returns the [Tagx] corresponding to code [String] [s]. A code [String]
  /// has the format "ggggeeee".
  static Tagx fromCodeString(String s) =>
      byIndex[TagBase.tagCodeStringToIndex(s)];

  /// Returns the [Tagx] corresponding to [keyword].
  static Tagx fromKeyword(String keyword) =>
      byIndex[TagBase.tagKeywordToIndex(keyword)];

  /// Returns the [Tagx] corresponding to [name].
  static Tagx fromName(String name) => byIndex[TagBase.tagNameToIndex(name)];

  /// A [List] of [Tagx]s by their index.
  static List<Tagx> byIndex = <Tagx>[];
}
