...
class VMx {
  ...
  // Constructor
  const VMx(this.keyword, this.min, this.max, this.rank, {this.isPrivate = false});
  ...
  // **** Rank 1 ****
  static const VMx k0_n = const VMx('k0-n', 0, -1, 1, isPrivate: true);
  ...
  static const VMx k1_16 = const VMx('k1-16', 1, 16, 1, isPrivate: true);
  static const VMx k1_32 = const VMx('k1-32', 1, 32, 1);
  static const VMx k1_99 = const VMx('k1-99', 1, 99, 1);
  static const VMx k1_143 = const VMx('k1-143', 1, 143, 1, isPrivate: true);
  static const VMx k1_256 = const VMx('k1-256', 1, 256, 1, isPrivate: true);
  static const VMx k1_n = const VMx('k1-n', 1, -1, 1);

  static const VMx k2 = const VMx('k2', 2, 2, 1);
  static const VMx k2_3 = const VMx('k2-3', 2, 3, 1, isPrivate: true);
  ...
  static const VMx k4_n = const VMx('k4-n', 4, -1, 1, isPrivate: true);

  static const VMx k5 = const VMx('k5', 5, 5, 1, isPrivate: true);

  static const VMx k6 = const VMx('k6', 6, 6, 1);
  static const VMx k6_n = const VMx('k6-n', 6, -1, 1);

  static const VMx k7 = const VMx('k7', 7, 7, 1, isPrivate: true);
  static const VMx k7_n = const VMx('k7-n', 7, -1, 1, isPrivate: true);

  static const VMx k8 = const VMx('k8', 8, 8, 1, isPrivate: true);
  static const VMx k9 = const VMx('k9', 9, 9, 1);

  static const VMx k12 = const VMx('k12', 12, 12, 1, isPrivate: true);
  static const VMx k12_n = const VMx('k12-n', 12, -1, 1, isPrivate: true);

  static const VMx k16 = const VMx('k16', 16, 16, 1);
  static const VMx k18 = const VMx('k18', 18, 18, 1, isPrivate: true);
  static const VMx k24 = const VMx('k24', 24, 24, 1, isPrivate: true);
  static const VMx k28 = const VMx('k28', 28, 28, 1, isPrivate: true);
  static const VMx k32 = const VMx('k32', 32, 32, 1, isPrivate: true);
  static const VMx k35 = const VMx('k35', 35, 35, 1, isPrivate: true);
  static const VMx k256 = const VMx('k256', 256, 256, 1, isPrivate: true);

  //If valid they need special lookup table
  static const VMx k40909 = const VMx('k40909', 40909, 40909, 1, isPrivate: true);
  static const VMx k40910 = const VMx('k40910', 40910, 40910, 1, isPrivate: true);
  static const VMx k40915 = const VMx('k40915', 40915, 40915, 1, isPrivate: true);
  static const VMx k40923 = const VMx('k40923', 40923, 40923, 1, isPrivate: true);
  ...
  // **** Rank 4 ****
  static const VMx k4_4n = const VMx('k4-4n', 4, -1, 4, isPrivate: true);

  // **** Rank 6 ****
  static const VMx k6_6n = const VMx('k6-6n', 6, -1, 6, isPrivate: true);

  // **** Rank 30 ****
  static const VMx k30_30n = const VMx('k30-30n', 30, -1, 30, isPrivate: true);

  // **** Rank 47 ****
  static const VMx k47_47n = const VMx('k47-47n', 47, -1, 47, isPrivate: true);
